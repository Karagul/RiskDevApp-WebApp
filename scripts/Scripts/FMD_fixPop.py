...
def main(emoveDataPath, popDataPath, savePath): # Main
    if emoveDataPath != None:
        ...
        emoveData = loadCSV('E_Movement_FMD_2017.csv', 1)                                   # Read emovement csv file
    if popDataPath != None:
        popData = loadCSV(popDataPath , 1)                # Read animal population csv file  
    else:    
        popData = loadCSV('Population_FMD_2017.csv' , 1)                               # Read animal population csv file 
    ...
    csvFile = ''
    if savePath != None:
        csvFile = savePath + '/CATTLE_POP.csv'                                            # Read emovement csv file
    else:
        csvFile = 'CATTLE_POP.csv'                                                        # Read emovement csv file
