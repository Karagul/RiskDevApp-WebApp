...
def main(directory, modelPath , fileName):
    ...
    try:
        ...
        subprocess.call("\"C:\\Program Files\\R\\R-3.5.1\\bin\\Rscript.exe\" --vanilla {0}/ASF_processingSubdistrictRisk.R {1} {2}".format(modelPath, directory, fileName), shell=True)
